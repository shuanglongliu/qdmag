...
from spin_dynamics.core.liouville import convert_rho_to_risvrho, set_up_liouville, evolve_rho_liouville_RK4
...
if __name__ == "__main__":
    ...
    h_t0_eff, h_tmin_eff, S2_eff, Sz_eff, Mx_eff, My_eff, Mz_eff, Mv_eff, X_eff, dim = \
      set_up_the_effective_system(h_t0_p, h_tmin_p, S2_tot_p, Sz_tot_p, Mv_tot_p, states)
    ...
    start = time.time()
    risvrho_eff = evolve_rho_liouville_RK4(tmin, tmax, deltat, Bt_params, risvrho0_eff, L_eff, L0_eff, h_t0_eff, Mz_eff, C_eff, CST_eff, X_eff, Rhbar_eff, lambdaa, I0, T, dim, dims, dimds, save_mag, nt_mag, save_rho, nt_rho)
    end   = time.time()
