...
def test_hdf5():
    fname = "/blue/m2qm-efrc/shuan.liu.neu/projects/spin_dynamics/output/vrhos_0.000-30.000_step0.001ps.h5"
    with h5py.File(fname, "r") as f1:
        h5keys = list ( f1.keys() )
        print("Keys in the file:", h5keys)
        # print("First 20 Keys in the file:", h5keys[0:20])

        # print(f1[h5keys[0]].shape)
        # print(f1[h5keys[0]][0:10, 0:10])

        # print(f1["20.000"][0:10])
        # print(f1["30.000"][0:10])

        # rho = np.array( f1["20.000"] )
        # print(rho[0:10])

        # print(dir(f1["20.000"]))

        tag = "10.000"
        dimds = f1[tag].shape[0]
        rho = np.array( f1[tag][0:dimds] )
        print(rho[0:10])
...
if __name__ == "__main__":
    ...
    # file1 = 'vrhos_0.000-10.000_step0.001ps.hdf5'
    # file2 = 'vrhos_10.000-30.000_step0.001ps.hdf5'
    # output_file = 'vrhos_0.000-30.000_step0.001ps.hdf5'
